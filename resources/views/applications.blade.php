                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 31px, 0px);">
                                            <a class="dropdown-item" href="{{ url('applications/show/' . $application->id) }}"><i data-feather="eye" width="20"></i> View</a>
                                            <a class="dropdown-item" href="{{ url('applications/edit/' . $application->id) }}"><i data-feather="edit" width="20"></i> Edit</a>
